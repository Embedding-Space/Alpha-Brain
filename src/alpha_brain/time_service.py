...
class TimeService:
    ...
    _timezone_cache: ClassVar[dict[str, str | datetime | None]] = {"timezone": None, "expires_at": None}
    ...
    def get_timezone(cls) -> str:
        ...
        if (cached_tz and 
            cached_expires and 
            isinstance(cached_expires, datetime) and
            cached_expires > now):
    ...
    @classmethod
    def format_for_context(cls, dt: str | datetime | DateTime, include_age: bool = True) -> str:
